        ...
        <div className="py-12 px-12 bg-white rounded-2xl shadow-xl w-96">
            ...
            <form onSubmit={ handleSubmit } noValidate="off">
                ...
                <div className="text-center mt-6">
                    <button className="py-3 w-full text-lg text-white bg-purple-500 rounded-lg hover:bg-purple-600 uppercase font-bold">
                        Entrar
                    </button>
                </div>
            </form>
            ...
            <div className="mt-3">
                <button onClick={ handleGoogleSignIn } className="py-3 w-full text-lg text-white bg-blue-500 rounded-lg hover:bg-blue-600 font-semibold">
                    Ingresar con Google
                </button>

                <div className='text-center mt-4'>
                    <Link to="/recuperar-password" className='text-gray-600'>¿Olvidaste tu contraseña?</Link>
                </div>
            </div>
